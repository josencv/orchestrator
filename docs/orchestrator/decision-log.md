...
This file classifies the major design choices that shape the orchestrator.
...
| Copilot CLI is the first broker, using the standalone `copilot` command.                                                       | New for this project    | Project context names Copilot CLI first.                                                                             | Fixed for v0.                                       | The broker surface should match the tools actually intended to be used first.                                             |
